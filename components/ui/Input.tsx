      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            type={inputType}
            className={cn(
              "w-full bg-[#1c1c1c] border border-[#2a2a2a] rounded-lg px-4 py-2.5 text-sm text-[#f5f5f5] placeholder:text-[#555] focus:outline-none focus:border-[#6b8c3a] focus:ring-1 focus:ring-[#6b8c3a] transition-colors",
              icon && "pl-10",
              isPassword && "pr-10",
